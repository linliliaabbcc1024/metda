angular
.module('blankapp').controller("median_normalizationController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("median_normalization_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Median Normalization - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.data_matrix), "Median Normalization "+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    to_be_saved_parameters.p = null
        var to_be_saved =
        [{
          "id":"median_normalization_dataset_"+time_stamp,
          "parent":undefined,
          "text":"Median Normalization",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"median_normalization",
          "parameters":to_be_saved_parameters
        },{
          "id":"median_normalization_dataset_"+time_stamp+".csv",
          "parent":"median_normalization_dataset_"+time_stamp,
          "text":"Median Normalization.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"median_normalization_dataset_"+time_stamp+".csv",
