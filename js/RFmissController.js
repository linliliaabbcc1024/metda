angular
.module('blankapp').controller("RFmissController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("RFmiss_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "RFmiss - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.data_matrix), "RFmiss-imputed "+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    to_be_saved_parameters.p = null
        var to_be_saved =
        [{
          "id":"RFmiss_dataset_"+time_stamp,
          "parent":undefined,
          "text":"RFmiss-imputed",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"RFmiss",
          "parameters":to_be_saved_parameters
        },{
          "id":"RFmiss_dataset_"+time_stamp+".csv",
          "parent":"RFmiss_dataset_"+time_stamp,
          "text":"RFmiss-imputed.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"RFmiss_dataset_"+time_stamp+".csv",
