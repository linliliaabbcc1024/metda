angular
.module('blankapp').controller("kruskal_wallis_testController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("kruskal_wallis_test_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Kruskal-Wallis test - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.result), "Kruskal-Wallis test"+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    var to_be_saved =
    [{
          "id":"kruskal_wallis_test_result_"+time_stamp,
          "parent":undefined,
          "text":"Kruskal-Wallis test",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"kruskal_wallis_test",
          "parameters":to_be_saved_parameters
        },{
    "id":"kruskal_wallis_test_result_"+time_stamp+".csv",
    "parent":"kruskal_wallis_test_result_"+time_stamp,
    "text":"Kruskal-Wallis test result.csv",
    "icon":"fa fa-file-excel-o",
    "attachment_id":"kruskal_wallis_test_dataset_"+time_stamp+".csv",
