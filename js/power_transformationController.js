angular
    .module('blankapp').controller("power_transformationController", function($scope, $rootScope, $timeout, $mdToast){
      ctrl = this;
      ...
      ctrl.method_options = ['square root',"cubic root"]
      ...
      ctrl.make_data_read_here = function(obj){
        ...
        ctrl.parameters.method = parameters.power_transformation.method
        $scope.$watch("ctrl.parameters",function(newValue, oldValue){
          parameters.power_transformation.method= ctrl.parameters.method
      ...
      ctrl.submit = function(){
        ...
        var req = ocpu.call("power_transformation_fun",ctrl.parameters,function(session){
          sss = session
          session.getObject(function(obj){
            oo = obj
      ...
      ctrl.download = function(){
        ...
        .then(function (blob) {
            saveAs(blob, "Power Transformation - Plots.zip");
        });*/

        download_csv(Papa.unparse(oo.data_matrix), "Power Transformation "+time_stamp+".csv")
      }
    ...
    to_be_saved_parameters.p = null
        var to_be_saved =
        [{
          "id":"power_transformation_dataset_"+time_stamp,
          "parent":undefined,
          "text":"Power Transformation",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"power_transformation",
          "parameters":to_be_saved_parameters
        },{
          "id":"power_transformation_dataset_"+time_stamp+".csv",
          "parent":"power_transformation_dataset_"+time_stamp,
          "text":"Power Transformation.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"power_transformation_dataset_"+time_stamp+".csv",
