angular
.module('blankapp').controller("anovaController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("anova_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "ANOVA - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.result), "ANOVA"+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    "id":"anova_result_"+time_stamp+".csv",
    "parent":"anova_result_"+time_stamp,
    "text":"ANOVA result.csv",
    "icon":"fa fa-file-excel-o",
    "attachment_id":"anova_dataset_"+time_stamp+".csv",
