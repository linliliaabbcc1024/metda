angular
.module('blankapp').controller("paired_t_testController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("paired_t_test_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Paired t-test - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.result), "Paired t-test"+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    var to_be_saved =
    [{
          "id":"paired_t_test_result_"+time_stamp,
          "parent":undefined,
          "text":"Paired t-test",
          "icon":"fa fa-folder",
          "main":true,
    ...
    "id":"paired_t_test_result_"+time_stamp+".csv",
    "parent":"paired_t_test_result_"+time_stamp,
    "text":"Paired t-test result.csv",
    "icon":"fa fa-file-excel-o",
    "attachment_id":"paired_t_test_dataset_"+time_stamp+".csv",
