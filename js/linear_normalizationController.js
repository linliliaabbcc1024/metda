angular
.module('blankapp').controller("linear_normalizationController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("linear_normalization_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Linear Normalization - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.data_matrix), "Linear Normalization "+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    to_be_saved_parameters.p = null
        var to_be_saved =
        [{
          "id":"linear_normalization_dataset_"+time_stamp,
          "parent":undefined,
          "text":"Linear Normalization",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"linear_normalization",
          "parameters":to_be_saved_parameters
        },{
          "id":"linear_normalization_dataset_"+time_stamp+".csv",
          "parent":"linear_normalization_dataset_"+time_stamp,
          "text":"Linear Normalization.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"linear_normalization_dataset_"+time_stamp+".csv",
