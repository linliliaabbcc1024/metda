angular
.module('blankapp').controller("liwong_normalizationController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("liwong_normalization_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Li-Wong Normalization - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.data_matrix), "Li-Wong Normalization "+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    to_be_saved_parameters.p = null
        var to_be_saved =
        [{
          "id":"liwong_normalization_dataset_"+time_stamp,
          "parent":undefined,
          "text":"Li-Wong Normalization",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"liwong_normalization",
          "parameters":to_be_saved_parameters
        },{
          "id":"liwong_normalization_dataset_"+time_stamp+".csv",
          "parent":"liwong_normalization_dataset_"+time_stamp,
          "text":"Li-Wong Normalization.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"liwong_normalization_dataset_"+time_stamp+".csv",
