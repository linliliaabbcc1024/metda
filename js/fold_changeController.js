angular
    .module('blankapp').controller("fold_changeController", function($scope, $rootScope, Upload, $timeout, $mdToast){
      ctrl = this;
      ...
      ctrl.make_data_read_here = function(obj){
        ...
        ctrl.parameters.method = parameters.fold_change.method
        ...
        $scope.$watch("ctrl.parameters",function(newValue, oldValue){
          parameters.fold_change.method= ctrl.parameters.method
      ...
      ctrl.submit = function(){
        ...
        var req = ocpu.call("fold_change",ctrl.parameters,function(session){
          sss = session
          session.getObject(function(obj){
            oo = obj
      ...
      ctrl.download = function(){
        download_csv(Papa.unparse(oo.result), "Fold Change Result.csv")
      }
      ...
      ctrl.save_result = function(){
        ...
        var to_be_saved =
        [{
          "id":"fold_change_dataset_"+time_stamp,
          "parent":undefined,
          "text":"Fold Change",
          "icon":"fa fa-folder",
          "main":true,
          ...
          "id":"fold_change_dataset_"+time_stamp+".csv",
          "parent":"fold_change_dataset_"+time_stamp,
          "text":"Fold Change.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"fold_change_dataset_"+time_stamp+".csv",
