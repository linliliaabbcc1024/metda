angular
.module('blankapp').controller("mann_whitney_u_testController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("mann_whitney_u_test_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Mann-Whitney U test - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.result), "Mann-Whitney U test"+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    var to_be_saved =
    [{
          "id":"mann_whitney_u_test_result_"+time_stamp,
          "parent":undefined,
          "text":"Mann-Whitney U test",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"mann_whitney_u_test",
          "parameters":to_be_saved_parameters
        },{
    "id":"mann_whitney_u_test_result_"+time_stamp+".csv",
    "parent":"mann_whitney_u_test_result_"+time_stamp,
    "text":"Mann-Whitney U test result.csv",
    "icon":"fa fa-file-excel-o",
    "attachment_id":"mann_whitney_u_test_dataset_"+time_stamp+".csv",
