angular
    .module('blankapp').controller("group_averageController", function($scope, $rootScope, $timeout, $mdToast){
      ctrl = this;
      ...
      ctrl.make_data_read_here = function(obj){
        ...
        ctrl.parameters.method = parameters.group_average.method
        ctrl.parameters.by_group = parameters.group_average.by_group
        ...
        $scope.$watch("ctrl.parameters",function(newValue, oldValue){
          parameters.group_average.method= ctrl.parameters.method
          parameters.group_average.by_group = ctrl.parameters.by_group
      ...
      ctrl.submit = function(){
        ...
        var req = ocpu.call("group_average_fun",ctrl.parameters,function(session){
          sss = session
          session.getObject(function(obj){
            oo = obj
      ...
      ctrl.download = function(){
        ...
        .then(function (blob) {
            saveAs(blob, "Group Average - Plots.zip");
        });*/

        download_csv(Papa.unparse(oo.data_matrix), "Group Average "+time_stamp+".csv")
      }
    ...
    to_be_saved_parameters.p = null
        var to_be_saved =
        [{
          "id":"group_average_dataset_"+time_stamp,
          "parent":undefined,
          "text":"Group Average",
          "icon":"fa fa-folder",
          "main":true,
          ...
          "id":"group_average_dataset_"+time_stamp+".csv",
          "parent":"group_average_dataset_"+time_stamp,
          "text":"Group Average.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"group_average_dataset_"+time_stamp+".csv",
