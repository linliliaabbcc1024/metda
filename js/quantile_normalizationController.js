angular
.module('blankapp').controller("quantile_normalizationController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("quantile_normalization_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Quantile Normalization - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.data_matrix), "Quantile Normalization "+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    to_be_saved_parameters.p = null
        var to_be_saved =
        [{
          "id":"quantile_normalization_dataset_"+time_stamp,
          "parent":undefined,
          "text":"Quantile Normalization",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"quantile_normalization",
          "parameters":to_be_saved_parameters
        },{
          "id":"quantile_normalization_dataset_"+time_stamp+".csv",
          "parent":"quantile_normalization_dataset_"+time_stamp,
          "text":"Quantile Normalization.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"quantile_normalization_dataset_"+time_stamp+".csv",
