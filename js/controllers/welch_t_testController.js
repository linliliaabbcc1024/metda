angular
.module('blankapp').controller("welch_t_testController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Welch t-test - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.result), "Welch t-test"+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    var to_be_saved =
    [{
          "id":"welch_t_test_result_"+time_stamp,
          "parent":undefined,
          "text":"Welch t-test",
          "icon":"fa fa-folder",
          "main":true,
    ...
    "id":"welch_t_test_result_"+time_stamp+".csv",
    "parent":"welch_t_test_result_"+time_stamp,
    "text":"Welch t-test result.csv",
    "icon":"fa fa-file-excel-o",
    "attachment_id":"welch_t_test_dataset_"+time_stamp+".csv",
