angular
.module('blankapp').controller("kNNmissController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("kNNmiss_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "kNNmiss - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.data_matrix), "kNNmiss-imputed "+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    to_be_saved_parameters.p = null
        var to_be_saved =
        [{
          "id":"kNNmiss_dataset_"+time_stamp,
          "parent":undefined,
          "text":"kNNmiss-imputed",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"kNNmiss",
          "parameters":to_be_saved_parameters
        },{
          "id":"kNNmiss_dataset_"+time_stamp+".csv",
          "parent":"kNNmiss_dataset_"+time_stamp,
          "text":"kNNmiss-imputed.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"kNNmiss_dataset_"+time_stamp+".csv",
