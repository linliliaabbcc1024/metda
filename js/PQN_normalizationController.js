angular
.module('blankapp').controller("PQN_normalizationController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("PQN_normalization_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "PQN Normalization - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.data_matrix), "PQN Normalization "+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    to_be_saved_parameters.p = null
        var to_be_saved =
        [{
          "id":"PQN_normalization_dataset_"+time_stamp,
          "parent":undefined,
          "text":"PQN Normalization",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"PQN_normalization",
          "parameters":to_be_saved_parameters
        },{
          "id":"PQN_normalization_dataset_"+time_stamp+".csv",
          "parent":"PQN_normalization_dataset_"+time_stamp,
          "text":"PQN Normalization.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"PQN_normalization_dataset_"+time_stamp+".csv",
