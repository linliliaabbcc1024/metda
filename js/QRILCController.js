angular
    .module('blankapp').controller("QRILCController", function($scope, $rootScope, $timeout, $mdToast){
      ctrl = this;
      ...
      ctrl.submit = function(){
        ...
        var req = ocpu.call("QRILC_fun",ctrl.parameters,function(session){
          ssss = session
          session.getObject(function(obj){
            oo = obj
      ...
      ctrl.download = function(){
        ...
        .then(function (blob) {
            saveAs(blob, "QRILC - Plots.zip");
        });*/

        download_csv(Papa.unparse(oo.data_matrix), "QRILC-imputed "+time_stamp+".csv")
      }
    ...
    to_be_saved_parameters.p = null
        ...
        [{
          ...
          "id":"QRILC_dataset_"+time_stamp+".csv",
          "parent":"QRILC_dataset_"+time_stamp,
          "text":"QRILC-imputed.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"QRILC_dataset_"+time_stamp+".csv",
