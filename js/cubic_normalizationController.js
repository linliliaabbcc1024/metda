angular
.module('blankapp').controller("cubic_normalizationController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("cubic_normalization_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Cubic Normalization - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.data_matrix), "Cubic Normalization "+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    to_be_saved_parameters.p = null
        var to_be_saved =
        [{
          "id":"cubic_normalization_dataset_"+time_stamp,
          "parent":undefined,
          "text":"cubic Normalization",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"cubic_normalization",
          "parameters":to_be_saved_parameters
        },{
          "id":"cubic_normalization_dataset_"+time_stamp+".csv",
          "parent":"cubic_normalization_dataset_"+time_stamp,
          "text":"cubic Normalization.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"cubic_normalization_dataset_"+time_stamp+".csv",
