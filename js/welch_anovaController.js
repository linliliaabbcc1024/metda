angular
.module('blankapp').controller("welch_anovaController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("welch_anova_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Welch ANOVA - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.result), "Welch ANOVA"+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    var to_be_saved =
    [{
          "id":"welch_anova_result_"+time_stamp,
          "parent":undefined,
          "text":"Welch ANOVA",
          "icon":"fa fa-folder",
          "main":true,
    ...
    "id":"welch_anova_result_"+time_stamp+".csv",
    "parent":"welch_anova_result_"+time_stamp,
    "text":"Welch ANOVA result.csv",
    "icon":"fa fa-file-excel-o",
    "attachment_id":"welch_anova_dataset_"+time_stamp+".csv",
