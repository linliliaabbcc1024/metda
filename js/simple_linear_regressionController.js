angular
.module('blankapp').controller("simple_linear_regressionController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("simple_linear_regression_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Simple Linear Regression - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.result), "Simple Linear Regression"+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    var to_be_saved =
    [{
          "id":"simple_linear_regression_result_"+time_stamp,
          "parent":undefined,
    ...
    "id":"simple_linear_regression_result_"+time_stamp+".csv",
    "parent":"simple_linear_regression_result_"+time_stamp,
    "text":"Simple Linear Regression result.csv",
    "icon":"fa fa-file-excel-o",
    "attachment_id":"simple_linear_regression_dataset_"+time_stamp+".csv",
