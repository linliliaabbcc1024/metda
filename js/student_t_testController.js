angular
.module('blankapp').controller("student_t_testController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("student_t_test_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Student t-test - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.result), "Student t-test"+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    var to_be_saved =
    [{
          "id":"student_t_test_result_"+time_stamp,
          "parent":undefined,
          "text":"Student t-test",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"student_t_test",
          "parameters":to_be_saved_parameters
        },{
    "id":"student_t_test_result_"+time_stamp+".csv",
    "parent":"student_t_test_result_"+time_stamp,
    "text":"Student t-test result.csv",
    "icon":"fa fa-file-excel-o",
    "attachment_id":"student_t_test_dataset_"+time_stamp+".csv",
