angular
.module('blankapp').controller("friedman_testController", function($scope, $rootScope, $timeout, $mdToast){
  ctrl = this;
  ...
  ctrl.submit = function(){
    ...
    var req = ocpu.call("friedman_test_fun",ctrl.parameters,function(session){
      sss = session
      session.getObject(function(obj){
        oo = obj
  ...
  ctrl.download = function(){
    ...
    .then(function (blob) {
      saveAs(blob, "Friedman test - Plots.zip");
    });*/

      download_csv(Papa.unparse(oo.result), "Friedman test"+time_stamp+".csv")
  }
  ...
  ctrl.save_result = function(){
    ...
    var to_be_saved =
    [{
          "id":"friedman_test_result_"+time_stamp,
          "parent":undefined,
          "text":"Friedman test",
          "icon":"fa fa-folder",
          "main":true,
          "analysis_type":"friedman_test",
          "parameters":to_be_saved_parameters
        },{
    "id":"friedman_test_result_"+time_stamp+".csv",
    "parent":"friedman_test_result_"+time_stamp,
    "text":"Friedman test result.csv",
    "icon":"fa fa-file-excel-o",
    "attachment_id":"friedman_test_dataset_"+time_stamp+".csv",
