angular
    .module('blankapp').controller("module_textController", function($scope, $rootScope, $timeout, $mdToast){
      ctrl = this;
      ...
      ctrl.submit = function(){
        ...
        var req = ocpu.call("module_text_fun",ctrl.parameters,function(session){
          sss = session
          session.getObject(function(obj){
            oo = obj
      ...
      ctrl.download = function(){
        ...
        .then(function (blob) {
            saveAs(blob, "module_name - Plots.zip");
        });*/

        download_csv(Papa.unparse(oo.data_matrix), "module_name "+time_stamp+".csv")
      }
      ...
      ctrl.save_result = function(){
        ...
        var to_be_saved =
        [{
          "id":"module_text_dataset_"+time_stamp,
          "parent":undefined,
          "text":"module_name",
          "icon":"fa fa-folder",
          "main":true
        },{
          "id":"module_text_dataset_"+time_stamp+".csv",
          "parent":"module_text_dataset_"+time_stamp,
          "text":"module_name.csv",
          "icon":"fa fa-file-excel-o",
          "attachment_id":"module_text_dataset_"+time_stamp+".csv",
